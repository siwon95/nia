...
public class EgovFileMngController {
	...
	public String selectFileInfs(@ModelAttribute("searchVO") FileVO fileVO,HttpServletRequest request, ModelMap model) throws Exception {
		String atchFileId = EgovStringUtil.nullConvert(request.getParameter("param_atchFileId"));
	...
	public String selectFileInfsForUpdate(@ModelAttribute("searchVO") FileVO fileVO,HttpServletRequest request,ModelMap model) throws Exception {
	...
	public String selectImageFileInfs(@ModelAttribute("searchVO") FileVO fileVO,HttpServletRequest request,ModelMap model) throws Exception {
