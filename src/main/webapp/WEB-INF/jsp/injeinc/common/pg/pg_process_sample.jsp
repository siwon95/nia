...
<c:choose>
	<c:when test="${UrlStr == 'lt'}">
		...
		<div class="pay-wrap">
			<p>전자결제가 진행중입니다.</p>
			<p>창을 닫거나 이동하실경우 결제가 완료되어도 정상적으로 예약이 완료되지 않습니다.</p>
			<p>결제가 완료되었으나 예약이 완료되지 않은경우 자동으로 결제가 취소되지 않을수도 있으므로 주의하셔야 합니다.</p>
			<br>
			<p>다양한 문제로 인해 <strong style="color:#b3714d;">결제가 되지 않는 경우</strong> 이를 해결할 수 있는 방법을 알려드립니다.</p>
			<ul class="con-icon2">
				<li>문의전화 : <strong class="blue">1544-7772</strong></li>
				<li>eCredit 결제오류 해결방안 : <a href="http://pgweb.uplus.co.kr/help.html" target="_blank" title="새창"><strong class="blue link new">바로가기</strong></a></li>
			</ul>
		</div>
