...
function agree() {
	...
	if (!chk1) {
		...
		document.UserFVo.action = "/site/yangcheon/user/User_Young_Step_03.do";
...
<h1>01통합회원_02약관동의_02어린이회원</h1>
	...
	<ol>
		...
		<li class="join-pr3">
			<div>
				...
				<h1 class="join-process-1"><span class="join-text">본인인증</span></h1>
			</div>
		</li>
		<li class="join-pr4">
			<div>
...
<div class="join-content-wrap join-process-2">
	...
	<div class="agreement">
		...
		<div tabindex="0">
			...
			<p>양천구청은 대민서비스를 제공하기 위해 필요한 개인정보를 수집합니다. 필수항목에 해당하는 정보를 입력하시지 않는 경우 회원가입이 불가능하나, 선택항목에 해당하는 정보를 입력하지 않으셔도 회원가입 및 서비스 이용에는 제한이 없습니다.</p>
			<h3>개인정보 수집항목</h3>
			<ul>
				<li>필수 : 성명, 비밀번호, 휴대폰번호, 주소, 이메일</li>
				<li>선택 : 유선전화, 뉴스레터</li>
			</ul>
				<h3>개인정보의 보유 및 이용 기간</h3>
			<ul>
				<li>수집된 개인정보는 개인의 탈퇴요청 시 까지 보유 이용됩니다.</li>
			</ul>
		</div>
		</article>
		<div class="agree-cell-box">
		...
		<article class="agree-box">
			...
			<ol>
				...
				<li>5. 개인정보를 목적 외의 용도로 이용하거나 이를 제3자에게 제공하지 아니하면 다른 법률에서 정하는 소관업무를 수행할 수 없는 경우로서 보호위원회의 심의&middot;의결을 거친 경우</li>
