...
$(document).ready(function() {
	...
	$.ajax({
		...
		success:function(data){
			$("#depthButton").append("<li class='active'><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1166'>전체</a></li>");
			$.each(data.cmmCode, function (index, item) {
				...
				if(searchDepth !=item.code){
					$("#depthButton").append("<li><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1166&searchDepth="+item.code+"'>"+item.codeName+"</a></li>");
				}else{
					$("#depthButton").append("<li class='active'><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1166&searchDepth="+item.code+"'>"+item.codeName+"</a></li>");
				} 
...
<form:hidden path="mode" />
	...
	<div class="board_list">
		...
		<div class="div_table b_type3 m_date">
			<div class="div_caption">직무연수 게시물 목록</div>
