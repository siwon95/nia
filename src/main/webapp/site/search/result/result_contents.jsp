...
%>
			...
			<div class="search-sub-wrap">
				<article class="content-row webpage">
					<h2>웹페이지 <span class="search-result-amout">[총 <strong class="text-point"><%=numberFormat(thisTotalCount)%></strong>건]</span></h2>
...
<%
			for(int idx = 0; idx < count; idx ++) {
                ...
                String SITE_DOMAIN              = wnsearch.getField(thisCollection,"SITE_DOMAIN",idx,false);
...
%>
				<li>
					<h3><a href="<%=LINK%>"><%=TITLE %></a> <span class="date"><%=DATE %></span></h3>
