	...
	var imgDir = "/js/nia/images/"			// directory for images ... e.g. var imgDir="/img/"
   ...
   function WeekNbr(n) {
	...
	function constructCalendar() {
		...
		for	( datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
		{
			...
			{ sHTML += "<b><a " + dateMessage + " title=\"" + sHint + "\" style='" + sStyle + "' href='javascript:dateSelected=" + datePointer + ";closeCalendar();'><font color=#ea01f7>&nbsp;" + datePointer + "</font>&nbsp;</a></b>" }
			...
			{ sHTML += "<a " + dateMessage + " title=\"" + sHint + "\" style='" + sStyle + "' href='javascript:dateSelected=" + datePointer + ";closeCalendar();'>&nbsp;<font color=#020af7>" + datePointer + "</font>&nbsp;</a>" }
			else
			{ sHTML += "<a " + dateMessage + " title=\"" + sHint + "\" style='" + sStyle + "' href='javascript:dateSelected=" + datePointer + ";closeCalendar();'>&nbsp;<font color=#909090>" + datePointer + "&nbsp;</a>" }
