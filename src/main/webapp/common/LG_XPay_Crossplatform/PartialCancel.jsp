...
<%
    ...
    String LGD_CANCELAMOUNT              = request.getParameter("LGD_CANCELAMOUNT");    //부분취소금액
    String LGD_CANCELREASON              = request.getParameter("LGD_CANCELREASON");    //부분취소사유
	...
	*/
    String configPath 			= EgovProperties.getProperty("lgdacom.configPath");	//LG유플러스에서 제공한 환경파일("/conf/lgdacom.conf") 위치 지정.
    ...
    xpay.Set("LGD_CANCELAMOUNT", LGD_TID);
    xpay.Set("LGD_CANCELREASON", LGD_TID);
