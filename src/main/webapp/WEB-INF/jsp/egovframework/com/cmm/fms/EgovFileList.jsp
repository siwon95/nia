...
<c:choose><c:when test="${updateFlag=='Y'}">
...
<li class="file">
						<a href="javascript:fn_egov_downFile('<c:out value="${fileVO.atchFileId}"/>','<c:out value="${fileVO.fileSn}"/>')">
							<c:out value="${fileVO.orignlFileNm}"/>&nbsp;[<c:out value="${fileVO.fileMg}"/>]
						</a>
			    		<a href="javascript:fn_egov_deleteFile('<c:out value="${fileVO.atchFileId}"/>','<c:out value="${fileVO.fileSn}"/>');">
			    			<img src="<c:url value='/images/site/cmm/btn_sdel.gif' />"  alt="삭제">
			    		</a>
</li>
				</c:when>
				<c:otherwise>
<li class="file">
						<a href="<c:url value='/cmm/fms/FileDown.do'/>?atchFileId=<c:out value="${fileVO.atchFileId}"/>&amp;fileSn=<c:out value="${fileVO.fileSn}"/>">
							<c:out value="${fileVO.orignlFileNm}"/>&nbsp;[<c:out value="${fileVO.fileMg}"/>]
						</a>
</li>
				</c:otherwise>
