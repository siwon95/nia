package egovframework.injeinc.foffice.pledge.vo;

import egovframework.cmm.ComDefaultVO;

@SuppressWarnings("serial")
public class PledgeFVo extends ComDefaultVO {
	private	int plIdx;
	...
	private	int wiwId; //지역
	private	String wiwName=""; //지역
	private	int wiwParent; //지역
	
	/*권한*/
	private	String writeAuthor; //쓰기 권한
	private	String modifyAuthor; //수정 권한
	private	String deleteAuthor; //삭제 권한
	...
	public void setWriteAuthor(String writeAuthor) {
		this.writeAuthor = writeAuthor;
	}
