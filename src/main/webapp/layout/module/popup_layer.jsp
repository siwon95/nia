...
var siteName = "...";
$(function(){
	if($(".mainPopupLayer").length > 0 && getCookie(siteName) == null) {
		$(".mainPopupLayer").show();
	}
	
	$(".mainPopupLayer #btn_popupCloseToday").click(function(){
		setCookie(siteName, "done", 1);
		$(".mainPopupLayer").hide();
	});
	$(".mainPopupLayer .btn_popupClose").click(function(){
		$(".mainPopupLayer").hide();
	});
});
</script>

<div class="mainPopupLayer">
	<ul>
