...
<h3>공지사항</h3>
	<div class="board_view">
		<div class="tit">
			...
			<span>
				<span><c:if test="${not empty detailMap.nameCont}"><c:out value="${detailMap.nameCont}" /></c:if></span>
				...
				<div class="divGroup cols2 pre_next_view">
					<div class="pre_view">
						...
						<c:when test="${prevNextList.NEXT_IDX ne null}">
							<strong>이전글</strong>
							<a href="<c:url value='/site/${strDomain}/ex/bbs/View.do?cbIdx=${bbsFVo.cbIdx }
																					&bcIdx=${prevNextList.NEXT_IDX }
																					&tgtTypeCd=${bbsFVo.tgtTypeCd }
																					&searchKey=${bbsFVo.searchKey}
																					&pageIndex=${bbsFVo.pageIndex}'/>">
