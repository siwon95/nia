...
$(document).ready(function() {
	...
	$.ajax({
		...
		dataType : "json",
		success:function(data){
			$("#depthButton").append("<li class='active'><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1156'>전체</a></li>");
			$.each(data.cmmCode, function (index, item) {
				...
				if(searchDepth !=item.code){
					$("#depthButton").append("<li><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1156&searchDepth="+item.code+"'>"+item.codeName+"</a></li>");
				}else{
					$("#depthButton").append("<li class='active'><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1156&searchDepth="+item.code+"'>"+item.codeName+"</a></li>");
				} 
