package egovframework.injeinc.foffice.ex.twitter.service;
...
public class TwitterInfo extends ComDefaultVO implements Serializable{
	...
	/** 트위터 소스 */
	 ...
	 /** 트위터 */
	 private String twitterdateDiff;
	...
	public String getTwitterdateDiff() {
		return twitterdateDiff;
	}

	public void setTwitterdateDiff(String twitterdateDiff) {
		this.twitterdateDiff = twitterdateDiff;
	}
