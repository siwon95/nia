			...
			<div class="board_list">
				<div class="board_search">
					...
					<ul>
						<li>
							<label>지역</label>
							<form:select title="조건선택" path="searchArea" class="w100">
					...
					<div class="w280">
						...
						<input type="text" name="searchKey" id="txt1" value="<c:out value='${bbsFVo.searchKey }'/>" class="w400" title="검색어입력" placeholder="주소를 입력해주세요">
				...
				<div class="div_table b_type4">
					...
					<div class="div_tbody">
						...
						<div class="div_tr">
							...
							<div class="div_td">
								<a class="baro" href=<c:out value="${contentList.SHORT_CUT}"/>>바로가기</a>
							</div>
						</div>
						</c:forEach>
					</div>
