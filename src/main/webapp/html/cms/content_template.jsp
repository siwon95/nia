...
<div class="content">
	...
	<div class="section">
		<ul class="thumbList site">
			<li>
				<div class="thumbImg">
					<a href="#modal_siteMod" class="btn_modalOpen"><img src="/images/cms/sample/sample_demo.jpg" alt="데모템플릿 메인" onerror="this.style.display='none';"></a>
			...
			<li>
				<div class="thumbImg">
					<a href="#modal_siteMod" class="btn_modalOpen"><img src="/images/cms/sample/sample_demo.jpg" alt="데모템플릿 서브" onerror="this.style.display='none';"></a>
					<div class="previewBox">
						<a href="#" class="btn_previewBoxOpen"><em>미리보기</em></a>
						<ul>
							<li class="item1"><a href="#" class="btn_windowPopup" data-url="#" data-option="width=1200,height=800"><em>데스크톱</em></a></li>
			...
			<li>
				<div class="thumbImg">
					<a href="#modal_siteMod" class="btn_modalOpen"><img src="/images/cms/sample/sample_yangcheon.jpg" alt="양천구청 메인" onerror="this.style.display='none';"></a>
					<div class="previewBox">
						<a href="#" class="btn_previewBoxOpen"><em>미리보기</em></a>
						<ul>
							<li class="item1"><a href="#" class="btn_windowPopup" data-url="#" data-option="width=1200,height=800"><em>데스크톱</em></a></li>
			...
			<li>
				<div class="thumbImg">
					<a href="#modal_siteMod" class="btn_modalOpen"><img src="/images/cms/sample/sample_yangcheon.jpg" alt="양천구청 서브" onerror="this.style.display='none';"></a>
					<div class="previewBox">
						<a href="#" class="btn_previewBoxOpen"><em>미리보기</em></a>
						<ul>
							<li class="item1"><a href="#" class="btn_windowPopup" data-url="#" data-option="width=1200,height=800"><em>데스크톱</em></a></li>
...
<div class="aside">
	...
	<div class="asideContent">
		<p>
			여러개의 템플릿에 대한 관리가 가능합니다.<br />
			화면 구성별로 템플릿을 만들어서 사용하세요.
		</p>
		<h6>템플릿 등록/수정</h6>
		<ul>
			...
			<table class="form">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<textarea id="layoutContent" name="layoutContent" title="템플릿 내용" class="w100p h100"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="form">
				...
				<tbody>
					...
					<tr>
						<th><label for="layoutContent">템플릿 내용</label></th>
						<td>
							<textarea id="layoutContent" name="layoutContent" title="템플릿 내용" class="w100p h100">&lt;%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%&gt;
...
&lt;decorator:body /&gt;
&lt;jsp:include page="/html/cms/layout/사이트코드/템플릿 코드/bottom.do" flush="true"/&gt;</textarea>
						</td>
					</tr>
				</tbody>
			</table>
