...
<%
    ...
    String LGD_ACTIVEXYN  = "N";

    /*
     * 가상계좌(무통장) 결제 연동을 하시는 경우 아래 LGD_CASNOTEURL 을 설정하여 주시기 바랍니다.
     */
    String LGD_CASNOTEURL		= "http://cms.yangcheon.go.kr/common/LG/cas_noteurl.jsp";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    String LGD_RETURNURL		= "http://cms.yangcheon.go.kr/common/LG/returnurl.jsp";// FOR MANUAL
     ...
     */
     ...
     String CST_WINDOW_TYPE = "popup";//수정불가
     ...
     payReqMap.put("LGD_ACTIVEXYN"  		, LGD_ACTIVEXYN );
...
<%
	...
	out.println(WebUtil.isMobile(request));
%>
</body>
