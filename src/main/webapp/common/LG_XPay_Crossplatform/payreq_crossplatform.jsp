...
<%
     ...
     */
    String LGD_CASNOTEURL		= "http://cms.yangcheon.go.kr/common/LG_XPay_Crossplatform/cas_noteurl.jsp";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    String LGD_RETURNURL		= "http://cms.yangcheon.go.kr/common/LG_XPay_Crossplatform/returnurl.jsp";// FOR MANUAL
