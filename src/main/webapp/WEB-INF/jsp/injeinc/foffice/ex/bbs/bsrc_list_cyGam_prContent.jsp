...
$(document).ready(function() {
	$.ajax({
		...
		data : {"cmmCode": 'DRP_TARGET',"cmmCode2th":'DRP_CONTENT'},
		dataType : "json",
		success:function(data){
			if(data.result){
    			...
    			$("#centerButton").append("<li class='active'><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1129'>전체</a></li>");
    			
    			$.each(data.cmmCode2th, function (index, item) {
    				var searchContent = '${bbsFVo.searchContent}';
    				 
    				if(searchContent !=item.code){
    					$("#centerButton").append("<li><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1129&searchContent="+item.code+"'>"+item.codeName+"</a></li>");
    				}else{
    					$("#centerButton").append("<li class='active'><a href='/site/${strDomain}/ex/bbs/List.do?cbIdx=1129&searchContent="+item.code+"'>"+item.codeName+"</a></li>");
    				}    
        		});
