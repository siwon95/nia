...
paramSet=mbRssCP.getContentHealthNoticeList(paramSet);
Iterator iter=paramSet.getList("ResultHealthNoticeList").iterator();
...
%><item>
		...
		<link><![CDATA[http://www.seocho.go.kr/site/sh/page.jsp?code=shl010000000&md=<%=beanMb_rss.getMd_idx().substring(3,9)%>&mode=view]]></link>
