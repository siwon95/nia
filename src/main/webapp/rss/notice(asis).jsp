...
paramSet=mbRssCP.getContentNoticeList(paramSet);
Iterator iter=paramSet.getList("ResultNoticeList").iterator();
...
%><item>
		...
		<link><![CDATA[http://www.seocho.go.kr/site/sd/page.jsp?code=sdg040010000&md=<%=beanMb_rss.getMd_idx().substring(3,9)%>&mode=view]]></link>
